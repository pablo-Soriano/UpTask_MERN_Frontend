...
const handleSubmit = async e => {
  ...
  try {
    const {data} = await baseUrlAxios.post(`/api/usuarios/olvide-password`, {email});
    setAlerta({
      msg:data.msg,
      error: false
    });
  ...
  return (
    <>
    <h1 className='text-sky-600 font-black text-5xl text-center'>Recupera tu acceso y no Pierdas <span className='text-slate-700'>tus proyectos</span></h1>
